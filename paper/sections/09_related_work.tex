...
The concrete object of this paper --- the $S_4$ median-plane quadrisection of the
regular tetrahedron --- is the $n=4$ member of the congruent-dissection atlas
of~\cite{babanskyyCongruentDissections}, which poses explicitly the question of
whether a known congruent dissection can be realised as a physical hinged
mechanism (naming $S_2$ and $S_4$ as natural edge-hinge candidates).  The present
certificate treats a \emph{zero-thickness relaxation} of the $S_4$ case that is
relevant to that question; it does \emph{not} resolve the physical hingeability
question (positive thickness, printable mechanism), which this paper explicitly
leaves open.
