"""TREE_007 refined-edge interval certificate overlay.

This audit promotes the TREE_007 refined-edge interval guard from a partial
probe to a complete refined-edge ledger by combining:

- the 1464 refined segments already fully certified by the original interval
  guard; and
- the 1064 failed refined segments closed by the residual-contact closure
  overlay.

It is an overlay/accounting certificate for the 2528 refined BFS spanning-tree
segments. It does not recompute every local SAT interval guard and does not
claim a continuous full 3-parameter component theorem.
"""
...
REPORT_NAME = "tree007_refined_edge_interval_certificate_overlay_report.json"
...
import audit_historical_s4_tree007_residual_contact_closure_overlay as closure_overlay  # noqa: E402
...
def reconstruct_segments_and_residuals() -> tuple[list[dict], list[dict], dict, dict]:
    ...
    residual_records, residual_source_meta = closure_overlay.reconstruct_records()
...
def consistency_checks(segments: list[dict], residual_records: list[dict], residual_source_meta: dict, segment_ledger: dict) -> dict:
    ...
    closure = load_json(RESULTS_DIR / "tree007_residual_contact_closure_overlay_report.json")
...
def build_report() -> dict:
    ...
    return {
        "case_id": CASE_ID,
        "status": "tree007_refined_edge_interval_certificate_overlay_completed",
        "source_reports": [
        ...
        "summary_metrics": {
            ...
            "tree007_refined_edge_interval_overlay_completed": checks["all_refined_segments_certified_by_overlay"] and checks["all_pair_segments_certified_by_overlay"],
        },
        "segment_ledger": segment_ledger,
        "consistency_checks": checks,
        "claim_boundary": [
            "This is a TREE_007 refined-edge overlay over the 2528 refined BFS spanning-tree segments.",
