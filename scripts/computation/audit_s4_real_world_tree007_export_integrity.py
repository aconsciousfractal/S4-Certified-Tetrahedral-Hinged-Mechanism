#!/usr/bin/env python
"""Audit TREE_007 RW8 export integrity and viewer-safety.

This audit is intentionally stricter/different from RW8:

* it rechecks every TREE_007 component export after vertex welding/cleanup;
...
OUT_DIR = RESULT_ROOT / "tree007_export_audit"
VIEWER_DIR = OUT_DIR / "inspection_viewer"
JSON_PATH = OUT_DIR / "tree007_export_integrity_audit.json"
MD_PATH = OUT_DIR / "TREE007_EXPORT_INTEGRITY_AUDIT.md"
VIEWER_OBJ_PATH = VIEWER_DIR / "TREE_007_viewer_inspection_grouped_mm.obj"
VIEWER_MTL_PATH = VIEWER_DIR / "TREE_007_viewer_inspection_grouped_mm.mtl"
VIEWER_MANIFEST_PATH = VIEWER_DIR / "TREE_007_viewer_inspection_grouped_mm_manifest.json"
PNG_PATH = OUT_DIR / "TREE_007_export_preview_views.png"
DATE = "2026-06-23"
...
def write_viewer_obj(component_records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    obj_lines = [
        ...
        "# TREE_007 inspection assembly in millimeters; grouped by RW8 exported component; not a fabrication file",
    ]
    mtl_lines: list[str] = []
...
def write_markdown(report: dict[str, Any]) -> None:
    ...
    text = f"""# TREE_007 export integrity audit
...
def main() -> None:
    ...
    report = {
        "audit_id": "S4-RW8-TREE007-EXPORT-INTEGRITY-AUDIT-2026-06-23",
        "date": DATE,
