#!/usr/bin/env python
"""Audit refined TREE_007 RW8d export integrity and viewer-safety.

This audit is intentionally stricter/different from RW8:

* it rechecks every refined TREE_007 component export after vertex welding/cleanup;
...
RW8_PATH = RESULT_ROOT / "rw8d_export_refined_tree007_report.json"
OUT_DIR = RESULT_ROOT / "rw8e_refined_tree007_export_audit"
VIEWER_DIR = OUT_DIR / "inspection_viewer"
JSON_PATH = OUT_DIR / "refined_tree007_export_integrity_audit.json"
MD_PATH = OUT_DIR / "REFINED_TREE007_EXPORT_INTEGRITY_AUDIT.md"
VIEWER_OBJ_PATH = VIEWER_DIR / "TREE_007_RW7E_refined_viewer_inspection_grouped_mm.obj"
VIEWER_MTL_PATH = VIEWER_DIR / "TREE_007_RW7E_refined_viewer_inspection_grouped_mm.mtl"
VIEWER_MANIFEST_PATH = VIEWER_DIR / "TREE_007_RW7E_refined_viewer_inspection_grouped_mm_manifest.json"
PNG_PATH = OUT_DIR / "TREE_007_RW7E_refined_export_preview_views.png"
DATE = "2026-06-23"
...
def write_viewer_obj(component_records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    obj_lines = [
        ...
        "# TREE_007 RW7e refined inspection assembly in millimeters; grouped by RW8d exported component; not a fabrication file",
    ]
    mtl_lines: list[str] = []
...
def write_markdown(report: dict[str, Any]) -> None:
    ...
    text = f"""# TREE_007 RW7e refined export integrity audit
...
def main() -> None:
    ...
    report = {
        "audit_id": "S4-RW8E-REFINED-TREE007-EXPORT-INTEGRITY-AUDIT-2026-06-23",
        "date": DATE,
        "status": "tree007_component_exports_complete_assembly_preview_not_viewer_safe",
